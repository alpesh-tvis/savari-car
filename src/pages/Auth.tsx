    ...
    try {
      if (isLogin) {
        ...
        toast({
          ...
          description: "Welcome to DriveShare.",
        });
      }
      navigate("/dashboard");
    } catch (error: any) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-hero p-12 items-center justify-center">
        <div className="max-w-md text-primary-foreground">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold">DriveShare</span>
          </div>
          <h2 className="text-4xl font-bold mb-6">
            Your Journey Starts Here
          </h2>
          <p className="text-xl text-primary-foreground/90">
            Join thousands of renters who trust our transparent and secure car rental platform.
          </p>
        </div>
      </div>
          ...
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="text-muted-foreground">
              {isLogin 
                ...
                : "Get started with your first rental"}
            </p>
          </div>
